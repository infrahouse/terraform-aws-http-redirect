...
- Exempt redirect bucket from cross-region-replication check
...
(resource rename). It will be re-released as 2.0.0 with proper semver.
The 2.0.0 entry will be generated by git-cliff after merge.
